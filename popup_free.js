// AI Privacy Shield - Popup UI Logic (FREE TIER)

// Cross-browser compatibility
const browserAPI = typeof browser !== "undefined" ? browser : chrome;

// Chrome Web Store Premium listing URL (update this after publishing)
const PREMIUM_STORE_URL = 'https://chrome.google.com/webstore/detail/ai-privacy-shield-premium/YOUR_PREMIUM_EXTENSION_ID';
...
document.getElementById('evidenceButton').addEventListener('click', () => {
    browserAPI.tabs.create({
        url: 'https://github.com/Pallyman/AIShield'
    });
});
...
**Extension Version:** 1.4.0`;
    ...
    browserAPI.tabs.create({
        url: `https://github.com/Pallyman/AIShield/issues/new?title=New%20Tracker%20Detected&body=${encodeURIComponent(template)}`
    });
});
...
// Upgrade to Premium - Opens Chrome Web Store
document.getElementById('upgradeButton')?.addEventListener('click', () => {
    browserAPI.tabs.create({ url: PREMIUM_STORE_URL });
});
...
function updateTierStatus() {
    ...
    trialStatusEl.textContent = 'FREE TIER';
    trialStatusEl.style.color = '#f59e0b';
    daysRemainingEl.parentElement.innerHTML = 'Blocking <strong>10 trackers</strong> • Upgrade for <strong>37+</strong>';
}
